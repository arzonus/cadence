...
import (
	...
	_sourceStore "github.com/uber/cadence/service/sharddistributor/store"
)

// meteredStore implements _sourceStore.Store interface instrumented with metrics.
type meteredStore struct {
	base
	wrapped _sourceStore.Store
}
...
func (c *meteredStore) AssignShards(ctx context.Context, namespace string, request _sourceStore.AssignShardsRequest, guard _sourceStore.GuardFunc) (err error) {
	op := func() error {
...
func (c *meteredStore) DeleteExecutors(ctx context.Context, namespace string, executorIDs []string, guard _sourceStore.GuardFunc) (err error) {
	op := func() error {
...
func (c *meteredStore) DeleteShardStats(ctx context.Context, namespace string, shardIDs []string, guard _sourceStore.GuardFunc) (err error) {
	op := func() error {
...
func (c *meteredStore) GetHeartbeat(ctx context.Context, namespace string, executorID string) (hp1 *_sourceStore.HeartbeatState, ap1 *_sourceStore.AssignedState, err error) {
	op := func() error {
...
func (c *meteredStore) GetShardOwner(ctx context.Context, namespace string, shardID string) (sp1 *_sourceStore.ShardOwner, err error) {
	op := func() error {
...
func (c *meteredStore) GetShardStats(ctx context.Context, namespace string, shardID string) (sp1 *_sourceStore.ShardStatistics, err error) {
	op := func() error {
		sp1, err = c.wrapped.GetShardStats(ctx, namespace, shardID)
		return err
	}
...
func (c *meteredStore) GetState(ctx context.Context, namespace string) (np1 *_sourceStore.NamespaceState, err error) {
	op := func() error {
...
func (c *meteredStore) RecordHeartbeat(ctx context.Context, namespace string, executorID string, state _sourceStore.HeartbeatState) (err error) {
	op := func() error {
...
func (c *meteredStore) SubscribeToAssignmentChanges(ctx context.Context, namespace string) (ch1 <-chan map[*_sourceStore.ShardOwner][]string, f1 func(), err error) {
	op := func() error {
